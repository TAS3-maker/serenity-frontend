        ...
        <div className="grid md:grid-cols-2 gap-6">
          ...
          <div className="border-2 border-dashed border-[#0D7377] rounded-xl p-6 text-left">
            ...
            <ul className="space-y-3 text-xl font-normal text-[#898989]">
              {[
                "10-question Financial Calm Assessment",
                "30-day personalised mission journey",
                "Private AES-256 encrypted Money Story Journal",
                "Financial Calm Score",
                "Daily insight cards",
                "Aarav AI companion built-in",
                "In-app community access",
              ].map((item, i) => (
                <li key={i} className="flex gap-2">
                  <div className="bg-[#0D7377] w-8 h-8 rounded-lg p-2"><img src={checkicon} alt="" width="100%" heigth="100%" /></div> {item}
                </li>
              ))}
            </ul>
          </div>
          ...
          {/* Right Box */}
          <div className="border-2 border-dashed border-teal-500 rounded-xl p-6 text-left">
