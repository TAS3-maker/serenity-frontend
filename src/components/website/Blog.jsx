...
const ARTICLES = [
  {
    ...
    time: "5 min read",
    title: "Why Willpower Fails Every Time — And What Actually Works",
    desc: "Every personal finance book tells you to budget more, spend less, discipline harder. Here's why that advice is scientifically backwards.",
    date: "Mar 14, 2026",
  },
  {
    category: "Stress Profiles",
    time: "6 min read",
    title: "Understanding Your Stress Profile: The Patterns Driving Financial Anxiety",
    desc: "Three are three dominant behavioral patterns driving financial stress. Which one describes you?",
    date: "Feb 28, 2026",
  },
  {
    category: "Behavioral Psychology",
    time: "4 min read",
    title: "Psychology Behind Spending Habits",
    desc: "Why we spend even when we don’t want to — decoded.",
    date: "Feb 22, 2026",
  },
  {
    category: "Research",
    time: "7 min read",
    title: "New Research on Financial Behavior",
    desc: "Latest studies reveal hidden patterns in money decisions.",
    date: "Feb 18, 2026",
  },
  {
    category: "Behavioral Science",
    time: "5 min read",
    title: "Why Willpower Fails Every Time — And What Actually Works",
    desc: "Every personal finance book tells you to budget more, spend less, discipline harder.",
    date: "Feb 21, 2026",
  },
];
    ...
    <div>
      ...
      <div className=" mx-auto text-center">
        ...
        <p className="text-[#898989] font-normal text-2xl mt-4 w-full max-w-5xl mx-auto">
          Science-backed insights on behavioral finance, stress patterns, and the path to financial contentment.
        </p>
        ...
        <div className="grid md:grid-cols-2">
          ...
          <div className="p-8 flex flex-col justify-center">
            ...
            <p className="text-[#898989] text-2xl font-normal mb-4">
              Financial avoidance feels protective in the moment. But the silence has a price — and it compounds daily.
            </p>

            <div className="flex justify-between items-center">
              <span className="text-[#898989] text-xl font-medium ">Mar 14, 2026</span>
